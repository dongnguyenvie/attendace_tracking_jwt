...
/**
 * The persistent class for the sen_live database table.
 * 
 */
@Entity
@Table(name="sen_live")
@NamedQuery(name="SenLive.findAll", query="SELECT s FROM SenLive s")
public class SenLive implements Serializable {
